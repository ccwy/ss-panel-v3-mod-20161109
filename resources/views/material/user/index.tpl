							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<STRIKE><p><i class="icon icon-lg">laptop_mac</i>&nbsp;iOS 下载<a href="/link/{$ios_token}">这个</a>，导入到 Surge 中，然后就可以随意切换服务器上网了。</p>
								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<dl class="dl-horizontal">
											...
											<dt>速度限制：<font color="red">限速 {$user->node_speedlimit}Mbps ，大概是因为你长时间高速下载，如有疑问请联系管理员</font></dt>
											{else}
